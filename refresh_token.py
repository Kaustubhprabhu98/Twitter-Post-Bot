...
def main():
    ...
    # Set up env with client id/secret
    rd_cfg = parse_auth("REDDIT")
    environ["praw_client_id"] = rd_cfg["CLIENT_ID"]
    environ["praw_client_secret"] = rd_cfg["CLIENT_SECRET"]

    reddit = praw.Reddit(
        redirect_uri=rd_cfg["REDIRECT_URI"],
        user_agent=rd_cfg["USER_AGENT"]
    )
